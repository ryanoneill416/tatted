  ...
  return (
    <Dropdown className="ml-2" drop="left">
      ...
      <Dropdown.Menu className="text-center">
        <Dropdown.Item className={styles.DropdownIcon} onClick={()=>{}} aria-label="edit"><i className="far fa-edit" /></Dropdown.Item>
        <Dropdown.Item className={styles.DropdownIcon} onClick={()=>{}} aria-label="delete"><i className="fas fa-trash-alt" /></Dropdown.Item>
      </Dropdown.Menu>
    </Dropdown>
  );
};
